  ...
  return (
    <>
      ...
      <div
        ...
        } ease-in-out duration-300 md:w-[35vw] md:relative md:h-[100vh] md:bg-white lg:w-[30vw] xl:w-[25vw]`}
      >
        <nav className="mt-20 text-1xl font-medium">
          ...
          <div className="fixed rounded bottom-0 left-[2.5%] h-40 w-[95%] mb-10 bg-white mx-auto flex flex-col justify-evenly items-center md:bg-gray-100">
            {loggedIn ? (
              <>
                <h3>
                  Welcome
